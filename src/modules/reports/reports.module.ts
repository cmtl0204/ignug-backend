...
@Module({
    ...
    controllers: [CareerReportsController, EnrollmentReportsController, StudentReportsController, GradeReportsController, PdfmakeController],
    providers: [CareerReportsService, StudentReportsService, EnrollmentReportsService, GradeReportsService, StudentSqlService, EnrollmentSqlService, PrinterService],
