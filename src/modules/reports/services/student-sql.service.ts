...
export class StudentSqlService {
    ...
    async findSocioeconomicFormAll(schoolPeriodId: string) {
        ...
        queryBuilder.select([
            ...
            'academic_degrees.name AS "Titulo académico"',
          ...
          .innerJoin(CatalogueEntity, 'ethnic_origins', 'ethnic_origins.id = users.ethnic_origin_id')
          .innerJoin(CatalogueEntity, 'genders', 'genders.id = users.gender_id')
          .innerJoin(CatalogueEntity, 'sexes', 'sexes.id = users.sex_id')
          .innerJoin(CatalogueEntity, 'marital_statuses', 'marital_statuses.id = users.marital_status_id')
          .innerJoin(CatalogueEntity, 'nationalities', 'nationalities.id = users.nationality_id')
          .innerJoin(OriginAddressEntity, 'origin_addresses', 'origin_addresses.model_id = users.id')
          .innerJoin(LocationEntity, 'countries', 'countries.id = origin_addresses.country_id')
          .innerJoin(LocationEntity, 'province_origins', 'province_origins.id = origin_addresses.province_id')
          .innerJoin(LocationEntity, 'canton_origins', 'canton_origins.id = origin_addresses.canton_id')
          .innerJoin(LocationEntity, 'parrish_origins', 'parrish_origins.id = origin_addresses.parish_id')
          .innerJoin(ResidenceAddressEntity, 'residence_addresses', 'residence_addresses.model_id = students.id')
          .innerJoin(LocationEntity, 'province_residences', 'province_residences.id = residence_addresses.province_id')
          .innerJoin(LocationEntity, 'canton_residences', 'canton_residences.id = residence_addresses.canton_id')
          .innerJoin(LocationEntity, 'parrish_residences', 'parrish_residences.id = residence_addresses.parish_id')
          .innerJoin(InformationStudentEntity, 'student_info', 'student_info.student_id = students.id')
          .leftJoin(CatalogueEntity, 'academic_periods', 'academic_periods.id = enrollments.academic_period_id')
          .leftJoin(CatalogueEntity, 'has_children', 'has_children.id = student_info.is_has_children_id')
          .leftJoin(CatalogueEntity, 'academic_degrees', 'academic_degrees.id = student_info.academic_degree_id')
          ...
          .leftJoin(CatalogueEntity, 'academic_degrees', 'academic_degrees.id = student_info.degree_superior_id')
          ...
          .leftJoin(CatalogueEntity, 'catastrophic_illnesses', 'catastrophic_illnesses.id = student_info.is_catastrophic_illness_id')
          .leftJoin(CatalogueEntity, 'family_catastrophic_illnesses', 'family_catastrophic_illnesses.id = student_info.is_family_catastrophic_illness_id')
          .leftJoin(CatalogueEntity, 'academic_degrees', 'academic_degrees.id = student_info.is_degree_superior_id')
          ...
          .leftJoin(CatalogueEntity, 'electronic_devices', 'electronic_devices.id = student_info.is_electronic_device_id')
          .leftJoin(CatalogueEntity, 'social_groups', 'social_groups.id = student_info.is_executed_community')
          .leftJoin(CatalogueEntity, 'academic_degrees', 'academic_degrees.id = student_info.is_executed_practice_id')
          .leftJoin(CatalogueEntity, 'family_kinship_disabilities', 'family_kinship_disabilities.id = student_info.is_family_disability_id')
          .leftJoin(CatalogueEntity, 'family_incomes', 'family_incomes.id = student_info.is_family_economic_aid_id')
          .leftJoin(CatalogueEntity, 'family_emigrants', 'family_emigrants.id = student_info.is_family_emigrant_id')
          .leftJoin(CatalogueEntity, 'family_properties', 'family_properties.id = student_info.is_family_properties_id')
          ...
          .leftJoin(CatalogueEntity, 'internet_types', 'internet_types.id = student_info.is_internet_id')
          .leftJoin(CatalogueEntity, 'academic_degrees', 'academic_degrees.id = student_info.is_lost_gratuity_id')
          ...
          .leftJoin(CatalogueEntity, 'academic_degrees', 'academic_degrees.id = student_info.is_study_other_career_id')
          .leftJoin(CatalogueEntity, 'academic_degrees', 'academic_degrees.id = student_info.is_subject_lost_id')
