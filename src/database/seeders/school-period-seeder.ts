    ...
    private async createSchoolPeriod() {
        ...
        for (const item of dataExcel) {
            ...
            const schoolPeriod: SeedSchoolPeriodDto = {
                ...
                ordinaryStartedAt: item['ordinary_started_at'],
                ordinaryEndedAt: item['ordinary_ended_at'],
                extraOrdinaryStartedAt: item['extraOrdinary_started_at'],
                extraOrdinaryEndedAt: item['extraOrdinary_ended_at'],
                especialStartedAt: item['especial_started_at'],
                especialEndedAt: item['especial_ended_at'],
                state,
            };
